...
namespace NewPustok.Migrations
{
    public partial class kdjfk : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Settings",
                columns: new[] { "Id", "Address", "Email", "Icon", "Logo", "Number" },
                values: new object[] { 1, "Azmiu Otaq 111", "Inara@Code.edu.az", "<i class='fa fa-user-o'></i>", "/image/logo.png", "+994555555555" });
